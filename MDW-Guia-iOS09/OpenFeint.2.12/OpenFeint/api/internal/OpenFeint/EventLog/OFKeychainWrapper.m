...
+ (void)clearKeychain
{
	NSString* keychainFile = [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0];
	keychainFile = [keychainFile stringByAppendingString:@"/ofx_simulator_keychain"];
