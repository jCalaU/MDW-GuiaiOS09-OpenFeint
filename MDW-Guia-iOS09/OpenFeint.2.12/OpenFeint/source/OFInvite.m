...
[OFResourceField fieldSetter:@selector(setSenderParameter:) getter:@selector(senderParameter)], @"sender_parameter",
[OFResourceField fieldSetter:@selector(setReceiverParameter:) getter:@selector(receiverParameter)], @"receiver_parameter",
